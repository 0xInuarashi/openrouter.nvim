...
local function init_config()
    if vim.g.ai_router_api_key ~= '' then
        M.config.api_key = vim.g.ai_router_api_key
    end
    if vim.g.ai_router_model ~= '' then
        M.config.model = vim.g.ai_router_model
    end
    if vim.g.ai_router_temperature ~= '' then
        M.config.temperature = vim.g.ai_router_temperature
    end
end
